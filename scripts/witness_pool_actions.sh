...
CIRCUIT_DIR="$ROOT/circuits/pool_actions"
...
field_arr("spend_deposit_secret", d["spend_deposit_secret"])
...
field_arr("out_deposit_secret", d["out_deposit_secret"])
print(f'pool_id = "{d["pool_id"]}"')
...
print(f'relayer_fee = "{d.get("relayer_fee", d.get("exit_hash", "0"))}"')
PY
