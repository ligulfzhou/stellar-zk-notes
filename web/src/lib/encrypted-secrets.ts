...
export function wrapKeyFromPasskeyPrf(prfOutput: Uint8Array): Uint8Array {
  return hkdf(sha256, prfOutput, new Uint8Array(), WRAP_AAD, 32);
}
...
export function encryptMnemonic(
  mnemonic: string,
  key: Uint8Array,
  method: EncryptedMnemonic["method"]
): EncryptedMnemonic {
