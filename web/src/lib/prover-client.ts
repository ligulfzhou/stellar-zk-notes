...
import type { UtxoWitnessPayload } from "./action-witness";
...
function witnessToNoirInputs(witness: UtxoWitnessPayload): InputMap {
  return {
    ...
    out_note_randomness: witness.out_note_randomness,
    out_recipient_pk: witness.out_recipient_pk,
