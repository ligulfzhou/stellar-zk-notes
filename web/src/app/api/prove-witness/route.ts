...
import type { UtxoWitnessPayload } from "@/lib/action-witness";
...
export async function POST(request: Request) {
  ...
  const body = (await request.json()) as { witness?: UtxoWitnessPayload };
  ...
  try {
    ...
    const proofFile = path.join(repoRoot, "artifacts", "utxo_actions", "proof");
