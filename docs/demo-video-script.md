...
> **Recommended upload:** **~4 minutes** — **[demo-video-script-4min.md](./demo-video-script-4min.md)** (standalone, easy to follow).  
> **Also available:** full walkthrough in this file (§2) · 2:30 ultra-short (§1, not recommended).  
...
### ★ Recommended primary cut (~4:00)

**→ See [demo-video-script-4min.md](./demo-video-script-4min.md)** for the standalone 4-minute script (timeline, narration, click paths, 2–3 min trim guide).
